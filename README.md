...
Google Earth Engine codes to correct the radiometric effects (caused by different Local Incidence Angle) in Sentinel-1 SAR data. 
...
#### Parameters of the function:
  ...
  - *year (type Integer)* - **available only for the LC-SLIAC_global version**
